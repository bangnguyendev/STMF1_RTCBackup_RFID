...
#define LCD16X2_RCC_GPIO_DATA			RCC_APB2Periph_GPIOB
#define LCD16X2_GPIO_DATA					GPIOB
#define LCD16X2_GPIO_D4						GPIOB
#define LCD16X2_GPIO_D5						GPIOB
#define LCD16X2_GPIO_D6						GPIOB
#define LCD16X2_GPIO_D7						GPIOB
// Pin definition
#define LCD16X2_PIN_RS	GPIO_Pin_4
#define LCD16X2_PIN_RW	GPIO_Pin_5
#define LCD16X2_PIN_EN	GPIO_Pin_6      // 3-bit dk
#define LCD16X2_PIN_D4	GPIO_Pin_0		
#define LCD16X2_PIN_D5	GPIO_Pin_1
